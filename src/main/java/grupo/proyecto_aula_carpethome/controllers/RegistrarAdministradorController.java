...
public class RegistrarAdministradorController {
    ...
    private void handleGuardar() {
        try {
            ...
            if (administradorService.existePorCedula(txtCedula.getText().trim())) {
            ...
            Administrador guardado = administradorService.registrarAdministrador(admin);

            // Mostrar éxito
            mostrarExito("Administrador creado exitosamente con ID: " + guardado.getIdAdmin());
